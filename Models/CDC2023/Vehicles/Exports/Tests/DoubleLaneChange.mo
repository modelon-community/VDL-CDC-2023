...
model DoubleLaneChange
    ...
    .CDC2023.Vehicles.Exports.DoubleLaneChange doubleLaneChange(world(enableAnimation = true)) annotation(Placement(transformation(extent = {{-8,-8},{12,12}},origin = {0,0},rotation = 0)));

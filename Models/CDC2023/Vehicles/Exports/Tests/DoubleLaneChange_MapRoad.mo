within CDC2023.Vehicles.Exports.Tests;
      ...
      model DoubleLaneChange_MapRoad
          extends .Modelon.Icons.Experiment;
          .CDC2023.Vehicles.Exports.DoubleLaneChangeMap doubleLaneChange(world(enableAnimation = true)) annotation(Placement(transformation(extent = {{-8,-8},{12,12}},origin = {0,0},rotation = 0)));

...
model BatteryController
    extends .Electrification.Batteries.Control.LimitsFixed(
      ...
      SoC_low=0.1,
      SoC_min=0);
    .CDC2023.Vehicles.Powertrains.Components.v_pack v_pack(causality = .Electrification.Utilities.Types.Causality.Input) annotation(Placement(transformation(extent = {{48.0,58.0},{40.0,66.0}},origin = {0.0,0.0},rotation = 0.0)));
equation

...
equation
    ...
    connect(longitudinalTracker.previewDistance[1],planning.previewDistance[2]) annotation(Line(points={{-14,-19},
          {-14,22},{-46,22},{-46,21}},                                                                                                                              color = {0,0,127}));
    connect(longitudinalTracker.previewDistance[2],planning.previewDistance[3]) annotation(Line(points={{-14,-19},
          {-14,22},{-46,22},{-46,21.3333}},                                                                                                                         color = {0,0,127}));

    connect(longitudinalTracker.previewTime[1],planning.previewTime[2]) annotation(Line(points={{-6,-19},
          {-6,21},{-54,21}},                                                                                                 color = {0,0,127}));

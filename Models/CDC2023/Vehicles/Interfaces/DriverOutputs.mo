...
connector DriverOutputs "Vehicle Outputs"
    ...
    .Modelica.Blocks.Interfaces.RealOutput rV_x(final quantity="Position", final unit="m") "Closed loop driver pathPoint x position";
    .Modelica.Blocks.Interfaces.RealOutput rV_y(final quantity="Position", final unit="m") "Closed loop driver pathPoint y position";

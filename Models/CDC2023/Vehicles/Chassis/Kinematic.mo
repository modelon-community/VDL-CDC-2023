...
models. Parameters are set in each sub-component.&nbsp;</p><p><span>The suspensions have been set up with high anti-dive and anti-squat to allow body attitude changes depending on how torque is distributed between the wheels.</span></p><p><span>The wheels have been parametrized to use the&nbsp;<a href=\"modelica://VehicleDynamics.Vehicles.Chassis.Wheels.ContactCalculation.Generic\">Generic</a>&nbsp;contact block and the geometry weighted method to interact with ground elevation data e.g. defined using the&nbsp;<a href=\"modelica://CDC2023.Grounds.WavyUneven\">WavyUneven</a>&nbsp;ground.</span></p>
